...
public class CMAudioService extends Service {
    ...
    public static final String SERVICE_INTERFACE
            = "cyanogenmod.app.AudioManagerService";
...
//            }
    ...
    private static native void native_registerAudioSessionCallback(boolean enabled);

    private static native int native_listAudioSessions(
